...
![sqs](./images/5e02a5c01ec65ecf35e6/sqs.png)

![stack](./images/5e02a5c01ec65ecf35e6/stack.png)
...
![cloudformation](./images/5e02a5c01ec65ecf35e6/cloudformation.png)
...
![cdk-app](./images/5e02a5c01ec65ecf35e6/cdk-app.png)
...
同じInfrastracture as Codeと言われる世界でも、Terraformや直接CloudFormationをいじるのと違い、普段開発を行っている言語で書けるという意味では、本当の意味での `as Code` な気もします。
